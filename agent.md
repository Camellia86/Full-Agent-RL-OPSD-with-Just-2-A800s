# FARO2 server agent runbook

FARO2 is a training-only project. Keep the working tree limited to the SFT stage, the teacher-free OPSD stage, their reward function, and launch documentation.
...
```text
outputs/faro2_qwen3_0p6b_s42/status.txt
outputs/faro2_qwen3_0p6b_s42/train.log
outputs/faro2_qwen3_0p6b_s42/resource_peak.tsv
outputs/faro2_qwen3_0p6b_s42/model.safetensors
```
